...
@section('content')
    <div class="max-w-5xl mx-auto">
        <div class="flex items-center justify-between mb-6">
            <h2 class="text-3xl font-bold text-gray-800">Edit Student</h2>
        ...
        <div class="bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-100">
            <div class="bg-gradient-to-r from-blue-600 to-blue-800 px-8 py-4">
                <p class="text-blue-100 text-sm">Update the details of the student below.</p>
            </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="mb-2">
                        ...
                        <select name="session"
                            ...
                            @foreach($sessions as $sess)
                                <option value="{{ $sess }}" {{ old('session', $student->session) == $sess ? 'selected' : '' }}>
                                    {{ $sess }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-span-1 md:col-span-2">
                        <label class="block text-gray-700 text-sm font-semibold mb-2">Student Photo <span
                                class="text-xs text-gray-500 font-normal ml-1">(Max 150KB, 300x300px)</span></label>
                        <div
                            ...
                            <div class="space-y-1 text-center">
                                <img id="photo_preview"
                                    src="{{ $student->photo ? asset('storage/' . $student->photo) : '#' }}" alt="Preview"
                                    class="mx-auto h-24 w-24 rounded-full object-cover mb-3 shadow-md {{ $student->photo ? '' : 'hidden' }}">

                                <svg id="photo_placeholder"
                                    class="mx-auto h-12 w-12 text-gray-400 {{ $student->photo ? 'hidden' : '' }}"
